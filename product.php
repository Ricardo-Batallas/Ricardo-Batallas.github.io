<?php include('templates/head.php'); ?>
    ...
    <section class="knowledge">
        <div class="knowledge__container container">
            <div class="knowledege__texts">
                <h2 class="subtitle">PLANES PARA  EMITIR FACTURAS  ELECTRÓNICAS Y NOTAS DE CRÉDITO</h2>
                <p class="knowledge__paragraph">
                    <ul>
                      <li>Facil y sencillo por su interfase amigable</li>
                      <li>Incluye facturas electrónicas y notas de crédito.</li>
                    </ul>
                </p>
                <br>
    ...
    <section class="knowledge">
        <div class="knowledge__container container">
            ...
            <!--inicio-->
            <div class="card">
                <div class="heading">$10.00 <span>INCLUYE</span><br>25 DOCUMENTOS</div>
                <div class="content">
                    <div class="item item--create">
                        <span class="tamaño_letra">MODOLOS</span>
                    </div>
